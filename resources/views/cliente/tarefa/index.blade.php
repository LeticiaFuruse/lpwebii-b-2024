...
@section('conteudo')
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-center">
            <button class="btn btn-primary mt-auto mb-3" data-toggle="modal" data-target="#modalCriarTarefa">Criar nova
                tarefa</button>
        </div>
        <div class="row">
            @foreach ($tarefa_unica as $itemTarefa)
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <div class="dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                    ...
                                    <form action="{{ route('tarefa-cliente-excluir', ['id' => $itemTarefa->id]) }}"
                                        method="GET">
                                        <button class="dropdown-item">Excluir tarefa</button>
                                    </form>
                                    <button class="dropdown-item" data-toggle="modal"
                                        data-target="#modal{{ $itemTarefa->id }}">Editar tarefa</button>
                            ...
                            <div class="container mt-4 mb-4">
                                ...
                                <div class="card">
                                    <div class="card-body d-flex flex-column">
                                        <h5 class="card-title"><strong>Titulo:</strong> {{ $itemTarefa->tarefa_titulo }}
                                        </h5>
                                        <p class="card-text"><strong>Descrição:</strong> {{ $itemTarefa->tarefa_descricao }}
                                        </p>
                ...
                @if (isset($itemTarefa))
                    <!-- Modal ALTERAR-->
                    <div class="modal " id="modal{{ $itemTarefa->id }}" tabindex="-1" role="dialog"
        ...
        <!-- Modal CRIAR-->
        <div class="modal " id="modalCriarTarefa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
