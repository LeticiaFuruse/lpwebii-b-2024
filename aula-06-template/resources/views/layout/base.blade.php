    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Nome Projeto</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/login">Informações de login</a>
                        <a class="collapse-item" href="/registro">Registro</a>
                        <a class="collapse-item" href="/tasks">Tasks</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Outras Pages:</h6>
